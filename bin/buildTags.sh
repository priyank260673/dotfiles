...
find /usr/local/share/drop/condor/condor_exa-5.1.4/include/condor_exa/  -regex ".*\.\(c\|h\|hpp\|cc\|cpp\|ipp\)" -print  | grep -v onetick | grep  -v "hawk/hawk/book"| grep -v "strategy/strategy/" |  grep -v "hawk/hawk/io/compression/brotli" >> ~/tags/cscope.files
cscope -Rb -q -i ~/tags/cscope.files -f ~/tags/cscope.out
## -------------------------------------- ## 

## ----------------------------------------------- ##
echo "Building release/nrc tags and CSCOPE files..."
find /home/ppatel/git/release_nrc_repo/example/sapphire  /usr/local/share/drop/condor/condor_exa-5.1.4/include/condor_exa -regex ".*\.\(c\|h\|hpp\|cc\|cpp\|ipp\)" -print | grep -v onetick | grep  -v "hawk/hawk/book" | grep -v "strategy/strategy/"|  grep -v "hawk/hawk/io/compression/brotli" | /home/ppatel/extra_git/ctags/ctags -R --sort=yes --tag-relative=yes --totals --recurse  --langmap=c:+.h --languages=c,c++ --links=yes --c-kinds=+p --c++-kinds=+p --extras="+qf" --language-force=C++ --fields=+ilasKS -L - --append -o ~/tags/relNrcTags
...
find /usr/local/share/drop/condor/condor_exa-5.1.4/include/condor_exa/  -regex ".*\.\(c\|h\|hpp\|cc\|cpp\|ipp\)" -print  | grep -v onetick | grep  -v "hawk/hawk/book"| grep -v "strategy/strategy/" |  grep -v "hawk/hawk/io/compression/brotli" >> ~/tags/relnrc_cscope.files
cscope -Rb -q -i ~/tags/relnrc_cscope.files -f ~/tags/relnrc_cscope.out
## -------------------------------------- ## 

## ----------------------------------------------- ##
echo "Building master repo tags and CSCOPE files..."
find /home/ppatel/git/master_repo/example/sapphire  /usr/local/share/drop/condor/condor_exa-5.1.4/include/condor_exa -regex ".*\.\(c\|h\|hpp\|cc\|cpp\|ipp\)" -print | grep -v onetick | grep  -v "hawk/hawk/book" | grep -v "strategy/strategy/"|  grep -v "hawk/hawk/io/compression/brotli" | /home/ppatel/extra_git/ctags/ctags -R --sort=yes --tag-relative=yes --totals --recurse  --langmap=c:+.h --languages=c,c++ --links=yes --c-kinds=+p --c++-kinds=+p --extras="+qf" --language-force=C++ --fields=+ilasKS -L - --append -o ~/tags/masterTags
...
find /usr/local/share/drop/condor/condor_exa-5.1.4/include/condor_exa/  -regex ".*\.\(c\|h\|hpp\|cc\|cpp\|ipp\)" -print  | grep -v onetick | grep  -v "hawk/hawk/book"| grep -v "strategy/strategy/" |  grep -v "hawk/hawk/io/compression/brotli" >> ~/tags/master_cscope.files
cscope -Rb -q -i ~/tags/master_cscope.files -f ~/tags/master_cscope.out
## -------------------------------------- ## 

## ----------------------------------------------- ##
#echo "Building Dev repo tags and CSCOPE files..."
#find /home/ppatel/git/dev_work/example/sapphire /usr/local/share/drop/condor/condor_exa-5.1.4/include/condor_exa  -regex ".*\.\(c\|h\|hpp\|cc\|cpp\|ipp\)" -print | grep -v onetick | grep  -v "hawk/hawk/book" | grep -v "strategy/strategy/"|  grep -v "hawk/hawk/io/compression/brotli" | /home/ppatel/extra_git/ctags/ctags -R --sort=yes --tag-relative=yes --totals --recurse  --langmap=c:+.h --languages=c,c++ --links=yes --c-kinds=+p --c++-kinds=+p --extras="+qf" --language-force=C++ --fields=+ilasKS -L - --append -o ~/tags/devTags
...
#find /usr/local/share/drop/condor/condor_exa-5.1.4/include/condor_exa/  -regex ".*\.\(c\|h\|hpp\|cc\|cpp\|ipp\)" -print  | grep -v onetick | grep  -v "hawk/hawk/book"| grep -v "strategy/strategy/" |  grep -v "hawk/hawk/io/compression/brotli" >> ~/tags/dev_cscope.files
...
find /usr/local/share/drop/condor/condor_exa-5.1.4/include/condor_exa/  -regex ".*\.\(c\|h\|hpp\|cc\|cpp\|ipp\)" -print  | grep  -v "hawk/hawk/book"| grep -v "strategy/strategy/" |  grep -v "hawk/hawk/io/compression/brotli" >> ~/tags/onetick_cscope.files
